...
EPISODES = {
    ...
    "ge03_a4":  ("ge03", "State, Market", "& Development Planning",
                  ...
                  "Episode 7 of 7"),
    # RBI DEPR 2026 — 6-episode MCQ series
    "rbi_a1":  ("rbi", "Macro MCQ", "IS-LM · AD-AS · Phillips Curve",
                 ["IS-LM Shifts & Traps", "AD-AS Stagflation", "Phillips Curve LRPC", "Monetary Transmission"],
                 "Episode 1 of 6"),
    "rbi_a2":  ("rbi", "Growth & Quant", "Harrod-Domar · Solow · OLS",
                 ["Harrod-Domar s/v Formula", "Solow Steady State", "Sen vs GDP", "OLS BLUE Conditions"],
                 "Episode 2 of 6"),
    "rbi_a3":  ("rbi", "Micro · Intl Trade", "& Public Finance",
                 ["Slutsky Decomposition", "Comparative Advantage", "J-Curve Effect", "Wagner's Law"],
                 "Episode 3 of 6"),
    "rbi_a4":  ("rbi", "RBI Instruments", "& Monetary Transmission",
                 ["Repo 5.25% · SDF · MSF", "125 bps Cut Since Feb 25", "MPC: 4% Target ±2%", "CRR/SLR/OMO Toolkit"],
                 "Episode 4 of 6"),
    "rbi_a5":  ("rbi", "Banking Regulation", "& Payment Systems",
                 ["CRAR 9% · GNPA 2.6%", "Basel III Tier 1 Capital", "IBC Resolution 330 Days", "UPI · CBDC · RTGS"],
                 "Episode 5 of 6"),
    "rbi_a6":  ("rbi", "Indian Economy", "Current Data 2026",
                 ["GDP 7.6% FY26E", "Fiscal Deficit 4.4%→4.3%", "Budget ₹53.47L cr", "Forex >11 Months Cover"],
                 "Episode 6 of 6"),
    # GE-04
